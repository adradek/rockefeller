...
describe KeysGenerator do
  ...
  describe "master key and chain code generation" do
    ...
    it "generates right private key" do
      expect(generator.private_key).to eq("084667a541b4a5be45d3c4ead6763308213ae474acd0fca2fd8008b41047ad8c")
    end
    ...
    it "presents private key and chain code as extended private key" do
      expect(generator.ext_private_key).to eq("084667a541b4a5be45d3c4ead6763308213ae474acd0fca2fd8008b41047ad8cba1c517fcf6b97b1cfbcda48d11998928d4d183c12ab276ff4c60be1437732d1")
    end
  end
end
